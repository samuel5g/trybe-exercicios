...
A função  `map`  é, talvez, uma das mais poderosas (e complexas!) funções para manipulação e criação de arrays. Em conjunto, essas  _HOFs_ deixarão o código mais legível, conciso e expressivo.
## Matéria :book:
