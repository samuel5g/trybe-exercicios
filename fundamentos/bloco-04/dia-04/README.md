# Dia 4 :rocket:
Aprendi sobre funções em Javascript. 

## Matéria :book:
Fui capaz de manipular objetos, usar o comando `for/in`, e utilizar funções para organizar e estruturar o meu código.
...
------
### Functions :gear:
Refatore os exercícios feitos no dia 4.1 e adicione funções neles
